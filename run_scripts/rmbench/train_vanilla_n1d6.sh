...
# Usage: DATASET_PATH=/path/to/rmbench bash run_scripts/rmbench/train_vanilla_n1d6.sh
#   RMBench modality (14-D abs-joint / 3-view) is preset (rmbench_config.py).
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-runs/rmbench/vanilla_n1d6}"
