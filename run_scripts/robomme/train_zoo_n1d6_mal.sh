...
# Usage: VIZ_BATCH_DIR=runs/robomme DATASET_PATH=data/robomme bash run_scripts/robomme/train_zoo_n1d6_mal.sh
...
OUTPUT_DIR="${OUTPUT_DIR:-runs/robomme/zoo_n1d6_mal}"  # where to save checkpoints and logs
