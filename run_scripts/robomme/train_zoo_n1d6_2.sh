...
# Usage: VIZ_BATCH_DIR=runs/robomme DATASET_PATH=data/robomme bash run_scripts/robomme/train_zoo_n1d6_2.sh
...
OUTPUT_DIR="${OUTPUT_DIR:-runs/robomme/zoo_n1d6_pool_non_key_moment}"
...
DELTA_THRESHOLD="${DELTA_THRESHOLD:-2.0}"              # key-moment threshold on normalized-joint window-end delta (only used when gate on)
